...
class TestParam:
    def test_set_get_value(self):
        param = Param(param_id='my_param', param_type=str)
    ...
    def test_default_value(self):
        param = Param(param_id='my_param', param_type=str, default='default_str')
    ...
    def test_reject_default_value_not_matching_type(self):
        with pytest.raises(ValueError):
            param = Param(param_id='my_param', param_type=int, default='default_str')

    def test_reject_assigning_value_not_matching_type(self):
        param = Param(param_id='my_int_param', param_type=int)
