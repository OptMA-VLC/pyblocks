...
class TestBlock:
    def test_has_input(self):
        block = Block(distribution_id=BlockDistributionId(''), instance_id='', name='')
        port_1 = Port(block=block, port_id=PortId('port_1'))
        port_2 = Port(block=block, port_id=PortId('port_2'))
